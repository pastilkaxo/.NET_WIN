...
namespace OOP2
{
    public partial class OwnerForm : Form
    {
        ...
        private void Accept_Click(object sender, EventArgs e)
        {
            ...
            else if(Fam.Text.Contains("--") || nam.Text.Contains("--"))
            {
            ...
            else
            {
                ...
                if ( Fam.Text == string.Empty || nam.Text == string.Empty)
                {
                ...
                else if (year2 > openY || (year2 == openY && Convert.ToInt32(month2) > openM) || (year2 == openY && Convert.ToInt32(month2) == openM && Convert.ToInt32(day2) > openD))
                {
        ...
        private void fath_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void Fam_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (!((inputChar >= 'А' && inputChar <= 'я')  || inputChar == '-'))
            {
                e.Handled = true; 
            }
        }
